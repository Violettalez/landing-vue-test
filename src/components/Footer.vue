    ...
    <div class="flex justify-between items-start mb-12">
      ...
      <div class="flex flex-col gap-4 mr-[30px] flex-3">
        ...
        <p class="font-montserrat font-normal text-base leading-[27px] text-gray-text">
          Trading with foreign exchange (FX), contract for differences (CFDs) and precious metals
          carries a high level of risk that may not be suitable for all investors. Leverage creates
          additional risk and loss exposure. Before you decide to trade foreign exchange or contract
          for differences, carefully consider your investment objectives, experience level, and risk
          tolerance.
        </p>
      </div>
      <div class="flex flex-col gap-4 mr-[96px] flex-3">
        ...
        <p class="font-montserrat font-normal text-base leading-[27px] text-gray-text">
          ...
          important to understand the possible consequences of investing. Traders should weigh their
          earning potential against the risks involved and act accordingly. Interactive Trade Ltd
